      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-3">
            {isAuthenticated ? (
              <>
                <span className="text-slate-600 font-medium px-4">Hi, {user?.name}</span>
                <button
                  onClick={() => logout()}
                  className="bg-slate-100 text-slate-700 px-6 py-2.5 rounded-xl hover:bg-slate-200 transition-all font-semibold"
                >
                  Logout
                </button>
              </>
          ...
          <div className="md:hidden py-4 border-t border-white/20 animate-slide-in">
            ...
            <div className="mt-4 space-y-2">
              {isAuthenticated ? (
                <button
                  onClick={() => logout()}
                  className="w-full bg-slate-100 text-slate-700 py-2.5 rounded-xl hover:bg-slate-200 transition-all font-semibold"
                >
                  Logout
                </button>
              ) : (
